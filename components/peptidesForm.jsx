    ...
    <div className="min-h-screen bg-gradient-to-b from-white to-blue-50 py-8 px-4">
      <div className="max-w-4xl mx-auto">
        ...
        <form onSubmit={handleSubmit} className="bg-white shadow-xl rounded-b-lg">
          ...
          <div className="p-8 border-b-2 border-gray-100">
            <div className="bg-gradient-to-r from-green-400 to-green-500 rounded-xl p-4 text-center mb-6">
              <h2 className="text-white text-lg font-bold">Sterile Compounded Products Rx</h2>
            </div>
            ...
            <div className="border-2 border-red-400 rounded-xl p-6 bg-red-50">
              <h3 className="text-lg font-bold text-red-900 mb-4">CONTROLLED MEDS</h3>
          ...
          <div className="p-8">
            ...
            <div className="space-y-6">
              ...
              <div>
                <label className="block text-sm font-semibold text-black mb-2">
                  Print Name * <span className="text-gray-600">(AUTHORIZED PRESCRIBER ONLY)</span>
                </label>
                <input
                  type="text"
                  required
